...
public class Messages {
    ...
    public static final String MESSAGE_PERSONS_SINGLE_LISTED_OVERVIEW = "%1$d person listed!";
    public static final String MESSAGE_PERSONS_MULTIPLE_LISTED_OVERVIEW = "%1$d persons listed!";
